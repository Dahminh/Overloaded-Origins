...
public class ParticlePower extends Power {
    ...
    public ParticlePower(PowerType<?> powerType, LivingEntity livingEntity, ParticleEffect particleEffect, Predicate<Pair<Entity, Entity>> biEntityCondition, int count, float speed, boolean force, Vec3d spread, double offsetX, double offsetY, double offsetZ, String yType, double scale, int frequency, boolean visibleInFirstPerson, boolean visibleWhileInvisible) {
    ...
    public static PowerFactory createFactory() {
        return new PowerFactory<>(
                OverloadedOrigins.identifier("particle"),
                new SerializableData()
                        ...
                        .add("y_type", SerializableDataTypes.STRING, "feet")
                        .add("scale", SerializableDataTypes.DOUBLE, 1.0D)
                ...
                data -> (powerType, livingEntity) -> new ParticlePower(
                        ...
                        data.get("scale"),
                        data.get("frequency"),
                        data.get("visible_in_first_person"), data.get("visible_while_invisible"))
        ).allowCondition();
    }
